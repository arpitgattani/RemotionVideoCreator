...
import { typedObjectKeys } from "@/lib/helpers";
...
export const FONT_FAMILIES = {
  ...
  "Dancing Script": () => import("@remotion/google-fonts/DancingScript"),
  "Cormorant Garamond": () =>
  ...
  "Roboto Mono": () => import("@remotion/google-fonts/RobotoMono"),
  ...
  "Varela Round": () => import("@remotion/google-fonts/VarelaRound"),
...
export const typedObjectKeysFontFamilies = typedObjectKeys(FONT_FAMILIES);
const [first, ...rest] = typedObjectKeysFontFamilies;

export const FontFamily = z.enum([first!, ...rest]);
