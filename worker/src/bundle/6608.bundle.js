"use strict";
(self["webpackChunkvideoapi"] = self["webpackChunkvideoapi"] || []).push([[6608],{
...
// EXTERNAL MODULE: ./node_modules/.pnpm/pixi.js@8.9.1/node_modules/pixi.js/lib/rendering/renderers/shared/texture/sources/ImageSource.mjs
var ImageSource = __webpack_require__(24286);
// EXTERNAL MODULE: ./node_modules/.pnpm/pixi.js@8.9.1/node_modules/pixi.js/lib/rendering/renderers/shared/texture/Texture.mjs + 2 modules
var Texture = __webpack_require__(80443);
...
;// ./node_modules/.pnpm/pixi.js@8.9.1/node_modules/pixi.js/lib/scene/text-bitmap/AbstractBitmapFont.mjs



"use strict";
class AbstractBitmapFont extends eventemitter3/* default */.A {
  constructor() {
    super(...arguments);
   ...
   */
  get font() {
    (0,deprecation/* deprecation */.t6)(deprecation/* v8_0_0 */.lj, "BitmapFont.font is deprecated, please use BitmapFont.fontFamily instead.");
   ...
   */
  get size() {
    (0,deprecation/* deprecation */.t6)(deprecation/* v8_0_0 */.lj, "BitmapFont.size is deprecated, please use BitmapFont.fontMetrics.fontSize instead.");
  ...
  get distanceFieldRange() {
    (0,deprecation/* deprecation */.t6)(deprecation/* v8_0_0 */.lj, "BitmapFont.distanceFieldRange is deprecated, please use BitmapFont.distanceField.range instead.");
  ...
  get distanceFieldType() {
    (0,deprecation/* deprecation */.t6)(deprecation/* v8_0_0 */.lj, "BitmapFont.distanceFieldType is deprecated, please use BitmapFont.distanceField.type instead.");
...
;// ./node_modules/.pnpm/pixi.js@8.9.1/node_modules/pixi.js/lib/scene/text-bitmap/utils/resolveCharacters.mjs
...
;// ./node_modules/.pnpm/pixi.js@8.9.1/node_modules/pixi.js/lib/scene/text-bitmap/DynamicBitmapFont.mjs
...
;// ./node_modules/.pnpm/pixi.js@8.9.1/node_modules/pixi.js/lib/scene/text-bitmap/utils/getBitmapTextLayout.mjs
...
;// ./node_modules/.pnpm/pixi.js@8.9.1/node_modules/pixi.js/lib/scene/text-bitmap/BitmapFontManager.mjs
...
/* harmony export */ });
/* harmony import */ var _color_Color_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(86363);
/* harmony import */ var _maths_matrix_Matrix_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6736);
/* harmony import */ var _rendering_renderers_shared_texture_Texture_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(80443);
/* harmony import */ var _utils_logging_warn_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(55707);
/* harmony import */ var _graphics_shared_fill_FillGradient_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(41857);
/* harmony import */ var _graphics_shared_fill_FillPattern_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(87357);
...
function getCanvasFillStyle(fillStyle, context, textMetrics, padding = 0) {
  if (fillStyle.texture === _rendering_renderers_shared_texture_Texture_mjs__WEBPACK_IMPORTED_MODULE_0__/* .Texture */ .g.WHITE && !fillStyle.fill) {
    return _color_Color_mjs__WEBPACK_IMPORTED_MODULE_1__/* .Color */ .Q.shared.setValue(fillStyle.color).setAlpha(fillStyle.alpha ?? 1).toHexa();
  } else if (!fillStyle.fill) {
    const pattern = context.createPattern(fillStyle.texture.source.resource, "repeat");
    const tempMatrix = fillStyle.matrix.copyTo(_maths_matrix_Matrix_mjs__WEBPACK_IMPORTED_MODULE_2__/* .Matrix */ .u.shared);
    tempMatrix.scale(fillStyle.texture.frame.width, fillStyle.texture.frame.height);
    pattern.setTransform(tempMatrix);
    return pattern;
  } else if (fillStyle.fill instanceof _graphics_shared_fill_FillPattern_mjs__WEBPACK_IMPORTED_MODULE_3__/* .FillPattern */ .m) {
    const fillPattern = fillStyle.fill;
    const pattern = context.createPattern(fillPattern.texture.source.resource, "repeat");
    const tempMatrix = fillPattern.transform.copyTo(_maths_matrix_Matrix_mjs__WEBPACK_IMPORTED_MODULE_2__/* .Matrix */ .u.shared);
    tempMatrix.scale(
      ...
      for (let i = 0; i < textMetrics.lines.length; i++) {
        ...
        fillGradient.colorStops.forEach((stop) => {
          ...
          gradient.addColorStop(
            ...
            _color_Color_mjs__WEBPACK_IMPORTED_MODULE_1__/* .Color */ .Q.shared.setValue(stop.color).toHex()
          );
        });
      }
    } else {
      fillGradient.colorStops.forEach((stop) => {
        gradient.addColorStop(stop.offset, _color_Color_mjs__WEBPACK_IMPORTED_MODULE_1__/* .Color */ .Q.shared.setValue(stop.color).toHex());
      });
    }
    return gradient;
  }
  (0,_utils_logging_warn_mjs__WEBPACK_IMPORTED_MODULE_5__/* .warn */ .R)("FillStyle not recognised", fillStyle);
  return "red";
}
...
//# sourceMappingURL=6608.bundle.js.map